...
Original file is located at
    https://colab.research.google.com/drive/1R5dneIjgcnF_7ZkMmNtXzP77cgVzw1vr
"""
...
import pandas as pd
df = pd.read_csv('resultadosFinalesLemas.csv')
...
dfT = pd.read_csv('resultadosFinalesLemasTest.csv')
len(dfT)
